  ...
  return (
    <div className="App">
      ...
      <div style={{ margin: "auto", width: "70%" }}>
        <h2 style={{ marginTop: "150px" }}>List Orders</h2>
        <table>
          <thead>
          ...
          <tbody>
            {orders.map((x) => (
              <tr key={x._id}>
                <td style={{ padding: "20px" }}>{x._id}</td>
                <td style={{ padding: "20px" }}>{x.amount / 100}</td>
                <td style={{ padding: "20px" }}>{x.isPaid ? "YES" : "NO"}</td>
                <td style={{ padding: "20px" }}>{x.razorpay.paymentId}</td>
              </tr>
            ))}
          </tbody>
        </table>
